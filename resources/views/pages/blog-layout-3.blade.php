    ...
    <div class="intro-y news p-5 box mt-8">
        ...
        <div class="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
            ...
            <div class="absolute sm:relative -mt-12 sm:mt-0 w-full flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm">
                <div class="mr-2">
                        Comments: <span class="font-medium">
                         {{ $fakers['totals']['orders'] ?? 0 }}</span>
                 </div>
                        <div class="mr-2">
                              Likes: <span class="font-medium">{{ $fakers[0]['totals']['reviews'] ?? 0 }}k</span>

                        </div>
                        <div class="ml-auto">
                           Views: <span class="font-medium">{{ $fakers[0]['totals']['purchases'] ?? 0 }}k</span>
                        </div>
            </div>
        ...
        <div class="intro-y text-justify leading-relaxed">
           <p class="mb-5">{{ $fakers[1]['news'][0]['short_content'] }}</p>
            <p class="mb-5">{{ $fakers[2]['news'][0]['short_content'] }}</p>
            <p>{{ $fakers[3]['news'][0]['short_content'] }}</p>
        </div>
